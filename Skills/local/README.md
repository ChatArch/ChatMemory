...
- Do not edit this template just to reflect the current machine's branch. Put machine-specific changes in the workspace-local copy, for example `<WORKSPACE_ROOT>/skills/local/...`.
